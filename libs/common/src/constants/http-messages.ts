...
export const CHAT_SUCCESS_MESSAGES = {
  ...
  GLOBAL_SEARCHED: 'Messages searched across chats successfully',
  ...
  MESSAGE_PINNED: 'Message pin updated successfully',
  PINNED_MESSAGES_FETCHED: 'Pinned messages retrieved successfully',
  MESSAGE_SCHEDULED: 'Message scheduled successfully',
  SCHEDULED_MESSAGES_FETCHED: 'Scheduled messages retrieved successfully',
